<%@page import="com.pams.model.Doctor"%>
<%-- <%@page import="java.io.PrintStream"%> --%>
<%@page import="com.pams.database.DatabaseConnection"%>
<%@page import="com.pams.dao.DoctorDao"%>
...
<body>
	 ...
	 <%
		...
		/* Doctor d = dao.getDoctorById(Integer.parseInt(id)); */
	%> 
	<div
      class="modal fade"
