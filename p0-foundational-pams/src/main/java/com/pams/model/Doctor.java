...
public class Doctor {
	...
	public String toString() {
		return "Doctor [doctorId=" + doctorId + ", doctorName=" + doctorName + ", educationDegree=" + educationDegree
				+ ", Speciality=" + Speciality + ", totalExperience=" + totalExperience + ", consultingTimeSlots="
				+ consultingTimeSlots + ", consultingCharges=" + consultingCharges + "]";
	}
